      ...
      <main className="min-h-screen bg-[#f8fafc] text-[#29496d]">
        ...
        <section className="mx-auto max-w-7xl px-8 py-10">
          <div className="grid gap-5 md:grid-cols-3 xl:grid-cols-6">
            ...
            <StatCard label="Community" value="Posts" />
          </div>
          ...
          <div className="mt-10 rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-500">
              Manage events, fixtures, predictions, teams, players and community
              feed posts from one CMS.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            ...
            <DashboardCard
              ...
              description="Manage fixtures, update scores, statuses and score predictions."
              href="/fixtures"
              badge="Available"
            />
            <DashboardCard
            ...
            <DashboardCard
              title="Create Event"
              description="Quickly add a new stream, VOD, teams, venue and match date."
              href="/events/create"
              badge="Quick action"
            />
          </div>
